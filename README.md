...
CRM система с минимальным набором возможностей: просмотр, добавление, удаление и редактирования данных клиентов
...
Для запуска сервера выполните команду `node crm-backend/index`. Для остановки нажмите сочетание клавиш CTRL+C.
